...
const ingredients = {
    mainIngredients: [
        { item: "Buah Stroberi", amount: "10-12 buah"},
...
const NasiGorengDetail = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            <Image source={require('../assets/stroberi.jpeg')} style={styles.image} />
            <Text style={styles.title}>Jus Strawberry 🍓🥤</Text>
            <Text style={styles.description}>
            Jus stroberi adalah minuman segar dengan rasa manis-asam khas stroberi. Jus ini sangat cocok dinikmati dalam keadaan dingin dan dikenal karena warnanya yang merah cerah serta aroma yang menyegarkan.
            </Text>
