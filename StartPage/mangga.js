...
const ingredients = {
    mainIngredients: [
        { item: "Buah Mangga", amount: "1 buah"},
...
const NasiGorengDetail = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            <Image source={require('../assets/mangga.jpeg')} style={styles.image} />
            <Text style={styles.title}>Jus Mangga 🥭🥤</Text>
            <Text style={styles.description}>
            Jus mangga adalah minuman tropis yang manis dan menyegarkan. Menggunakan mangga matang, jus ini memiliki tekstur kental dan aroma khas yang memikat. Cocok untuk dinikmati di hari panas.
            </Text>
